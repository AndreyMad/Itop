  ...
  return (
    <ul className={style.list}>
      <li className={style.item}>
        <NavLink className={style.navLink} to={routes.PROFILES_PAGE.path}>
          Profiles
        </NavLink>
        <img alt="presentation" className={style.svg} src={profilesSvg}></img>
      </li>
      <li className={style.item}>
        <NavLink className={style.navLink} to={routes.DASHBOARD_PAGE.path}>
          Dashboard
        </NavLink>
        <img alt="presentation" className={style.svg} src={dashboardSvg}></img>
      </li>
      <li className={style.item}>
        <NavLink className={style.navLink} to={routes.USERS_PAGE.path}>
          Users
        </NavLink>
