  ...
  return (
    <div className={style.cardWrapper}>
      ...
      <div className={style.btnWrapper}>
        <button className={style.btnL} onClick={() => showModal(profile)}>
          <span>Edit</span>
          <img className={style.svg} alt="edit button" src={editSvg}></img>
        </button>
        <button
          className={style.btnR}
          onClick={() => deleteHandler(profile.id)}
        >
          <span>Delete</span>
          <img alt="delete button" className={style.svg} src={thrashSvg}></img>
        </button>
      </div>
    </div>
  );
